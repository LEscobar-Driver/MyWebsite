                ...
                <Grid.Row>
                    <Grid.Column width={12}>
                        ...
                        <List style={{"color":"white"}} as="h2">
                            <List.Item>
                                Languages : <span style={{"color":"red"}}>Python{c} Javascript{c} Node{c} React{c} HTML{c} SQL{c} Shell{p}</span>
                            </List.Item>
                            <List.Item></List.Item>
                            <List.Item>
                                AWS Services : <span style={{"color":"red"}}>Serverless Framework{c} Lambda{c} Layers{c} API Gateway{c} SNS{c} SQS{c} S3{c} EC2{c} Cloud9{c} Cloudformation{c} Cloudwatch{c} IAM{p}</span>
                            </List.Item>
                            <List.Item></List.Item>                            
                            <List.Item>
                            ...
                            <List.Item></List.Item>
                            <List.Item>
                                More Tools : <span style={{"color":"red"}}>Docker{c} Flask{c} SQLAlchemy{c} Unittest{c} Pytest{c} Mocha{c} Selenium{c} Headless Chromium{p}</span>
                            </List.Item>
                            <List.Item></List.Item>
                            <List.Item>
